...
#include "roomie_msgs/msg/detail/battery_status__rosidl_typesupport_fastrtps_c.h"
...
using _BatteryStatus__ros_msg_type = roomie_msgs__msg__BatteryStatus;


ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_roomie_msgs
bool cdr_serialize_roomie_msgs__msg__BatteryStatus(
  const roomie_msgs__msg__BatteryStatus * ros_message,
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_roomie_msgs
bool cdr_deserialize_roomie_msgs__msg__BatteryStatus(
  eprosima::fastcdr::Cdr & cdr,
  roomie_msgs__msg__BatteryStatus * ros_message)
{
  // Field name: robot_id
  {
    cdr >> ros_message->robot_id;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_roomie_msgs
size_t get_serialized_size_roomie_msgs__msg__BatteryStatus(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_roomie_msgs
size_t max_serialized_size_roomie_msgs__msg__BatteryStatus(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = roomie_msgs__msg__BatteryStatus;
    is_plain =
      (
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_roomie_msgs
bool cdr_serialize_key_roomie_msgs__msg__BatteryStatus(
  const roomie_msgs__msg__BatteryStatus * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: robot_id
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_roomie_msgs
size_t get_serialized_size_key_roomie_msgs__msg__BatteryStatus(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _BatteryStatus__ros_msg_type * ros_message = static_cast<const _BatteryStatus__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_roomie_msgs
size_t max_serialized_size_key_roomie_msgs__msg__BatteryStatus(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const roomie_msgs__msg__BatteryStatus * ros_message = static_cast<const roomie_msgs__msg__BatteryStatus *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_roomie_msgs__msg__BatteryStatus(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  roomie_msgs__msg__BatteryStatus * ros_message = static_cast<roomie_msgs__msg__BatteryStatus *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_roomie_msgs__msg__BatteryStatus(cdr, ros_message);
}

static uint32_t _BatteryStatus__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_roomie_msgs__msg__BatteryStatus(
...
static size_t _BatteryStatus__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_roomie_msgs__msg__BatteryStatus(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, roomie_msgs, msg, BatteryStatus)() {
