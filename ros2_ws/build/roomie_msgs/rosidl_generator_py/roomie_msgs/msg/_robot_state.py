...
class RobotState(metaclass=Metaclass_RobotState):
    ...
    def __init__(self, **kwargs):
        ...
        self.robot_state_id = kwargs.get('robot_state_id', int())
    ...
    def __eq__(self, other):
        ...
        if self.robot_id != other.robot_id:
            return False
        if self.robot_state_id != other.robot_state_id:
            return False
        return True
    ...
    def robot_state_id(self):
        """Message field 'robot_state_id'."""
        return self._robot_state_id

    @robot_state_id.setter
    def robot_state_id(self, value):
        if self._check_fields:
            assert \
                isinstance(value, int), \
                "The 'robot_state_id' field must be of type 'int'"
            assert value >= -2147483648 and value < 2147483648, \
                "The 'robot_state_id' field must be an integer in [-2147483648, 2147483647]"
        self._robot_state_id = value
