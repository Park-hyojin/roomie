...
#include "roomie_msgs/msg/detail/robot_state__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const roomie_msgs::msg::RobotState & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  roomie_msgs::msg::RobotState & ros_message)
{
  // Member: robot_id
  cdr >> ros_message.robot_id;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = roomie_msgs::msg::RobotState;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const roomie_msgs::msg::RobotState *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<roomie_msgs::msg::RobotState *>(
    untyped_ros_message);
...
{
  return &roomie_msgs::msg::typesupport_fastrtps_cpp::_RobotState__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, roomie_msgs, msg, RobotState)() {
  return &roomie_msgs::msg::typesupport_fastrtps_cpp::_RobotState__handle;
}
