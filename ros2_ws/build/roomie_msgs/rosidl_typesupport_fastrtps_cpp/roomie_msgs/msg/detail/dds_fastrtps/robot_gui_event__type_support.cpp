...
#include "roomie_msgs/msg/detail/robot_gui_event__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = roomie_msgs::msg::RobotGuiEvent;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const roomie_msgs::msg::RobotGuiEvent *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<roomie_msgs::msg::RobotGuiEvent *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _RobotGuiEvent__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const roomie_msgs::msg::RobotGuiEvent *>(
...
static size_t _RobotGuiEvent__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_RobotGuiEvent(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _RobotGuiEvent__callbacks = {
  "roomie_msgs::msg",
  "RobotGuiEvent",
...
static rosidl_message_type_support_t _RobotGuiEvent__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_RobotGuiEvent__callbacks,
...
{
  return &roomie_msgs::msg::typesupport_fastrtps_cpp::_RobotGuiEvent__handle;
}
