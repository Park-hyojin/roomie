    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'roomie_msgs.srv.Location_Request')
            logger.debug(
...
class Metaclass_Location_Response(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'roomie_msgs.srv.Location_Response')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Metaclass_Location_Event(type):
    """Metaclass of message 'Location_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'roomie_msgs.srv.Location_Event')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__location__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__location__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__location__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__location__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__location__event
...
class Location_Event(metaclass=Metaclass_Location_Event):
    """Message class 'Location_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<roomie_msgs/Location_Request, 1>',
        'response': 'sequence<roomie_msgs/Location_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['roomie_msgs', 'srv'], 'Location_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['roomie_msgs', 'srv'], 'Location_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from roomie_msgs.srv import Location_Request
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 len(value) <= 1 and
                 all(isinstance(v, Location_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'Location_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from roomie_msgs.srv import Location_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, Location_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'Location_Response'"
...
class Metaclass_Location(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from roomie_msgs.srv import _location
            ...
            if _location.Metaclass_Location_Event._TYPE_SUPPORT is None:
                _location.Metaclass_Location_Event.__import_type_support__()


class Location(metaclass=Metaclass_Location):
    from roomie_msgs.srv._location import Location_Request as Request
    from roomie_msgs.srv._location import Location_Response as Response
    from roomie_msgs.srv._location import Location_Event as Event
