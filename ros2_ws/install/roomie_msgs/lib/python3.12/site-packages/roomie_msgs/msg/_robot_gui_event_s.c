...
bool roomie_msgs__msg__robot_gui_event__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("roomie_msgs.msg._robot_gui_event.RobotGuiEvent", full_classname_dest, 46) == 0);
  }
  roomie_msgs__msg__RobotGuiEvent * ros_message = _ros_message;
  {  // robot_id
  ...
  {  // rgui_event_id
    PyObject * field = PyObject_GetAttrString(_pymsg, "rgui_event_id");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->rgui_event_id = (int32_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
  {  // task_id
...
{
  /* NOTE(esteve): Call constructor of RobotGuiEvent */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("roomie_msgs.msg._robot_gui_event");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "RobotGuiEvent");
  ...
  {  // rgui_event_id
    PyObject * field = NULL;
    field = PyLong_FromLong(ros_message->rgui_event_id);
    {
      int rc = PyObject_SetAttrString(_pymessage, "rgui_event_id", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
