...
public:
  ...
  : msg_(msg)
  {}
  Init_PerformTask_Goal_target_location_id task_type_id(::roomie_msgs::action::PerformTask_Goal::_task_type_id_type arg)
  {
...
public:
  ...
  : msg_(msg)
  {}
  ::roomie_msgs::action::PerformTask_Feedback task_id(::roomie_msgs::action::PerformTask_Feedback::_task_id_type arg)
  {
    msg_.task_id = std::move(arg);
    return std::move(msg_);
  }
